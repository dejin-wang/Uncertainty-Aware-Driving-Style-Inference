...
# === Step 1 ===
def load_obs_style_trajectories(file_paths, state_dim=18, feature_dim=6):
...
if __name__ == "__main__":
    test_file = "PPO_obs_and_rewards200.csv"
    #99950,118350, 145700
    checkpoint = "transformer_weights_gaussian/epoch_145600.pth"
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    all_trajectories = load_obs_style_trajectories(test_file, state_dim=18, feature_dim=6)
    dataset = TrajectoryStreamDataset(all_trajectories, state_dim=18, feature_dim=6,
                                      window_min_len=20, window_max_len=30)
